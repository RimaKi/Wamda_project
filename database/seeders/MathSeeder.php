...
class MathSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $typeQuestion = ['عرض أشكال', 'عرض الكلمة', 'اختر الإجابة', 'عرض على مستقيم الأعداد',
            'عرض الخيارات', 'عرض الأعداد', 'عملية جمع', 'عملية طرح' ,'توصيل','تحليل','قراءة','كتابي'];

        $typeAnswer = ['إدخال رقم', 'صوت', 'اختيار خيار واحد', 'اختيار متعدد', 'مصفوفة مرتبة','توصيل بشكل عشوائي','صورة'];
